...
export default function SignIn() {
  ...
  const [errorMessage, setErrorMessage] = useState(""); // ⬅️ state error baru
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // kalau respon gagal (misalnya status 401)
    ...
    <Card className="max-w-md mx-auto">
      ...
      <CardContent>
        <div className="grid gap-4">
          ...
          {/* Google Login */}
          <div
            className={cn("w-full gap-2 flex items-center justify-between flex-col")}
          >
            <Button
              variant="outline"
